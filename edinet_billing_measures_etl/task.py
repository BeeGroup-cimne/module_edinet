...
from module_edinet.edinet_billing_measures_etl.hadoop_job import Hadoop_ETL

class ETL_mh_hadoop_billing(BeeModule2):
    """
    ETL to move billing measures from mongo to hadoop
    1. Get the billing measures from Mongo
    ...
    """
    def __init__(self):
        super(ETL_mh_hadoop_billing, self).__init__("edinet_billing_measures_etl")
    ...
    def module_task(self, params):
        ...
        self.logger.info('Starting MongoDB-HBase ETL using Hadoop to upload billing information...')
        ...
        projection = {
            'reading': 1,
            'deviceId': 1,
            'timestamp_start_bill': 1,
            'timestamp_end_bill':1,
            'companyId': 1,
            'values': 1,
            '_id': 0
        }
