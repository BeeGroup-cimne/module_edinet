...
from module_edinet.edinet_gam_baseline_prediction.align_job import MRJob_align
import sys

from timezonefinder import TimezoneFinder


class ModelPrediction(BeeModule3):
    def __init__(self):
        super(ModelPrediction, self).__init__("edinet_gam_baseline_prediction")
    ...
    def module_task(self, params):
        ...
        cursor = self.mongo[modelling_units_collection].find({"stationId":"X6"}).limit(5)
        for item in cursor :
...
if __name__ == "__main__":
    ...
    """
from module_edinet.edinet_gam_baseline_prediction.task import ModelPrediction
from datetime import datetime
params = {'result_companyId': 1092915978,'ts_to': datetime(2018, 4, 1, 23, 59, 59)}
t = ModelPrediction()
t.run(params) 
    """
